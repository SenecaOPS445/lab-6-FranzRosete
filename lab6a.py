...
class Student:
    ...
    def displayGPA(self):
        if not self.courses or all(self.courses[course] == 0.0 for course in self.courses):  # Prevent division by zero
    ...
    def displayCourses(self):
        ...
        return listOfCourses  # Return as a list to match unit test expectations
